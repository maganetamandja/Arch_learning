...
list_of_feature.push_back("animal_name");
list_of_feature.push_back("hair");
list_of_feature.push_back("feathers");
list_of_feature.push_back("eggs");
list_of_feature.push_back("milk");
list_of_feature.push_back("airborne");
list_of_feature.push_back("aquatic");
list_of_feature.push_back("predator");
list_of_feature.push_back("toothed");
list_of_feature.push_back("backbone");
list_of_feature.push_back("breathes");
list_of_feature.push_back("venomous");
list_of_feature.push_back("fins");
list_of_feature.push_back("legs");
list_of_feature.push_back("tail");
list_of_feature.push_back("domestic");
list_of_feature.push_back("catsize");
list_of_feature.push_back("class_type_string");
list_of_feature.push_back("positive_negative");
